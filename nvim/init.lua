...
local bicep_lsp_bin = "/Users/rafal/Applications/bicep-langserver/Bicep.LangServer.dll"
...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(ev)
		...
		map("n", "<leader>lff", vim.lsp.buf.format, "Format LSP")

		-- Formatting (Conform)
		map("n", "<leader>lfc", function()
